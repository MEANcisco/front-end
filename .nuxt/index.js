...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Laboratorio Clínico Alemán - Expertos en exámenes médicos ","htmlAttrs":{"lang":"es"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Laboratorio Clínico Alemán, con mas de 300 exámenes, uno de los laboratorios mas completos del Maule."},{"name":"format-detection","content":"telephone=yes"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (process.client && typeof nuxt_plugin_vuevideobackground_16f4d8ea === 'function') {
    await nuxt_plugin_vuevideobackground_16f4d8ea(app.context, inject)
  }
